...
if __name__ == "__main__":
    ...
    checkpoint_file = "/usr/data/soyers/ddff_paper_weights/snapshot-121256.npz"
    ...
    evaluator = DDFFTFLearnEval.DDFFTFLearnEval(checkpoint_file, focal_stack_size=tmp_datareader.get_stack_size())
    #Evaluate
